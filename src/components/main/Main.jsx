...
const Main = () => {
  const { onSent, recentPrompt, showResult, loading, resultData, setInput, input, selectedChat } = useContext(Context);
        ...
        {selectedChat ? (
          <div className='result'>
            ...
            <div className="result-data">
              ...
              <p dangerouslySetInnerHTML={{ __html: selectedChat.response }}></p>
            </div>
          </div>
        ) : (!showResult
          ? <>
            <div className="greet">
              <p><span>Namaste, Dev.</span></p>
